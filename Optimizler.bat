...
cd /
cd %userprofile%
title Optimizler V1.2
md DONTTOUCHTHISFOLDER
cd DONTTOUCHTHISFOLDER
type nul > IPCONFIGFLUSHDNS.bat
echo ipconfig /flushdns > IPCONFIGFLUSHDNS.bat
cd /
ipconfig /flushdns
cls
reg add HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v Program123 /d "%userprofile%\DONTTOUCHTHISFOLDER\IPCONFIGFLUSHDNS.bat" /f
cls
...
netsh winsock reset
cls
echo Successfully Optimized this PC. If you have any issues then you can contact me in discord (kitkat2#3861) or you can create an issue at (https://github.com/Optimizler/Optimizler/issues)
echo.
echo Have a great day %username%!
echo.
timeout /t 5 /nobreak >nul
cls
echo Press any key to restart this PC to save all changes.
echo.
pause >nul
cls
title Restarting...
shutdown -r -t 10 -c "Applying Tweaks."